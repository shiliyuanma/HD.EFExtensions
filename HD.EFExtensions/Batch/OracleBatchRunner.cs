    ...
    public class OracleBatchRunner : IBatchRunner
    {
...
#endif
        {
            ...
            try
            {
                ...
                if (deleteCommand.Parameters != null && deleteCommand.Parameters.Count > 0)
                {
                ...
                sqlBuilder.AppendLine(string.Format("DELETE FROM {0} j0 ", entityMap.TableName));
                sqlBuilder.AppendLine("WHERE EXISTS (");
                sqlBuilder.AppendLine(innerSelect);
                if (innerSelect.Contains("WHERE") || innerSelect.Contains("where"))
                {
                ...
                foreach (var keyMap in entityMap.KeyMaps)
                {
                    ...
                    sqlBuilder.AppendFormat("j0.{0} = \"Extent1\".\"{0}\"", keyMap.ColumnName);
                    wroteKey = true;
                }
                ...
                deleteCommand.Parameters.AddRange(selectParameters.ToArray());

                //���sql��� �������
                if(BatchLog.DeleteLog != null)
                {
                    BatchLog.DeleteLog.Invoke(deleteCommand.CommandText, deleteCommand.Parameters);
                }
#if NET45
                int result = async
...
#endif
        {
            ...
            try
            {
                ...
                List<DbParameter> selectParameters = new List<DbParameter>();
                if(updateCommand.Parameters != null && updateCommand.Parameters.Count > 0)
                {
                ...
                var sqlBuilder = new StringBuilder(innerSelect.Length * 2);
                sqlBuilder.AppendLine(string.Format("UPDATE {0} j0 ", entityMap.TableName));
                ...
                updateCommand.Parameters.AddRange(selectParameters.ToArray());

                //���sql��� �������
                if (BatchLog.UpdateLog != null)
                {
                    BatchLog.UpdateLog.Invoke(updateCommand.CommandText, updateCommand.Parameters);
                }
